...
public class GameBoard {
	...
	private void createBoard() {
		...
		boardDeck = new ArrayList<Card>(Collections.nCopies(totalLocations, null));
	...
	/**
	 * Getter for currentCard at given index.
	 * @param index int for index of chosen card
	 * @return Card currentCard
	 */
	public Card getCard(int index) {
		Card currentCard =  boardDeck.get(index);
		return currentCard;
	}
}
